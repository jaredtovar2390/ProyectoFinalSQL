...
create table Adeudo
(
idAdeudo INT not null auto_increment primary key,
...
(
idCertificado INT not null auto_increment primary key,
fecha datetime not null,
...
(
idColegiatura INT not null auto_increment primary key,
...
(
idConcurso INT not null auto_increment primary key,
fecha datetime not null,
responsable varchar(50) not null,
nombre varchar(50) not null,
...
(
idConferencia INT not null auto_increment primary key,
fecha datetime not null,
responsable varchar(50) not null,
titulo varchar(40) not null,
...
(
idCredencialEscolar INT not null auto_increment primary key,
...
(
idCredito INT not null auto_increment primary key,
...
(
idEditorial INT not null auto_increment primary key,
nombre varchar(50) not null,
telefono char(10) not null,
estado varchar(50) not null,
numero char(5) not null,
...
(
idFeriaCiencia INT not null auto_increment primary key,
...
(
idResidencia INT not null auto_increment primary key,
nombre varchar(40) not null,
estado varchar(50) not null,
numero char(5) not null,
colonia varchar(50) not null,
...
(
idServicioSocial INT not null auto_increment primary key,
nombre varchar (40) not null,
fecha datetime not null,
cantidadHoras char(3) not null,
descripcion varchar (100) not null,
...
create table Tesis
(
idTesis INT not null auto_increment primary key,
...
create table Toefl
(
idToefl INT not null auto_increment primary key,
nombre varchar (50) not null,
descripcion varchar (100) not null,
fecha datetime not null,
...
(
idTipoArea INT not null auto_increment primary key,
nombre varchar (50) not null,
descripcion varchar (150) not null,
estatus  BIT DEFAULT 1 not null,
idUsuarioCrea int not null,
...
(
idTipoExamen INT not null auto_increment primary key,
nombre varchar (50) not null,
descripcion varchar (100) not null,
estatus  BIT DEFAULT 1 not null,
fecha datetime not null,
...
(
idTransporteEscolar INT not null auto_increment primary key,
nombre varchar (50) not null,
cantidad char(2) not null,
estatus  BIT DEFAULT 1 not null,
idUsuarioCrea int not null,
...
(
idPractica INT not null auto_increment primary key,
...
(
idRecurso INT not null auto_increment primary key,
fechaInicio datetime not null,
fechaFinal datetime not null,
descripcion varchar(100) not null,
estatus  BIT DEFAULT 1 not null,
...
(
idSinodal INT not null auto_increment primary key,
nombre varchar(50) not null,
apellidoPaterno varchar(50) not null,
apellidoMaterno varchar(50) not null,
telefono char(10) not null,
...
(
idAsignaturaProfesor INT not null auto_increment primary key,
...
(
idAsignaturaCarrera INT not null auto_increment primary key,
idAsignatura int not null,
...
(
idAlumnoPrestamo INT not null auto_increment primary key,
...
(
idAlumnoCredito INT not null auto_increment primary key,
idAlumno int not null,
...
(
idAlumnoColegiatura INT not null auto_increment primary key,
idAlumno int not null,
...
(
idAlumnoKardex INT not null auto_increment primary key,
idAlumno int not null,
...
(
idAlumnoConcurso INT not null auto_increment primary key,
idAlumno int not null,
...
(
idAlumnoAsignatura INT not null auto_increment primary key,
idAlumno int not null,
idAsignatura int not null,
estatus  BIT DEFAULT 1 not null);
...
(
idAlumnoExamen INT not null auto_increment primary key,
idAlumno int not null,
...
(
idAlumnoHorario INT not null auto_increment primary key,
idAlumno int not null,
...
(
idAlumnoVacacion INT not null auto_increment primary key,
idAlumno int not null,
...
(
idAlumnoProyecto INT not null auto_increment primary key,
idAlumno int not null,
...
(
idAlumnoTesis INT not null auto_increment primary key,
idAlumno int not null,
...
(
idAutorLibro INT not null auto_increment primary key,
...
(
idCategoriaLibro INT not null auto_increment primary key,
...
(
idCertificadoCurso INT not null auto_increment primary key,
...
(
idColegiaturaEmpleado INT not null auto_increment primary key,
idColegiatura int not null,
...
(
idConcursoEmpleado INT not null auto_increment primary key,
idConcurso int not null,
idEmpleado int not null,
estatus  BIT DEFAULT 1 not null);
...
(
idConferenciaEmpleado INT not null auto_increment primary key,
...
(
idConferenciaProfesor INT not null auto_increment primary key,
idConferencia int not null,
idProfesor int not null,
estatus  BIT DEFAULT 1 not null);
...
(
idContratoEmpleado INT not null auto_increment primary key,
...
(
idContratoProfesor INT not null auto_increment primary key,
idContrato int not null,
idProfesor int not null,
estatus  BIT DEFAULT 1 not null);
...
(
idConvocatoriaProfesor INT not null auto_increment primary key,
...
(
idConvocatoriaEmpleado INT not null auto_increment primary key,
idConvocatoria int not null,
idEmpleado int not null,
estatus  BIT DEFAULT 1 not null);
...
(
idEditorialLibro INT not null auto_increment primary key,
...
(
idEmpleadoKardex INT not null auto_increment primary key,
idEmpleado int not null,
idKardex int not null,
estatus  BIT DEFAULT 1 not null);
...
(
idEmpleadoServicioSocial INT not null auto_increment primary key,
idEmpleado int not null,
idServicioSocial int not null,
estatus  BIT DEFAULT 1 not null);
...
(
idEmpleadoResidencia INT not null auto_increment primary key,
idEmpleado int not null,
idResidencia int not null,
estatus  BIT DEFAULT 1 not null);
...
(
idEquipoTaller INT not null auto_increment primary key,
...
(
idHorarioProfesor INT not null auto_increment primary key,
idHorario int not null,
idProfesor int not null,
estatus  BIT DEFAULT 1 not null);
...
(
idPracticaProfesor INT not null auto_increment primary key,
...
(
idProfesorProyecto INT not null auto_increment primary key,
idProyecto int not null,
idProfesor int not null,
estatus  BIT DEFAULT 1 not null);
...
(
idProfesorVacacion INT not null auto_increment primary key,
idVacacion int not null,
idProfesor int not null,
estatus  BIT DEFAULT 1 not null);
...
(
idProyectoSinodal INT not null auto_increment primary key,
idProyecto int not null,
...
(
idSinodalTesis INT not null auto_increment primary key,
idTesis int not null,
idSinodal int not null,
estatus  BIT DEFAULT 1 not null);
